...
/**
 * displays the game, responsible for the button actions and the logic of the game
 * @author Marijus Gudiskis 1901701
 */
public class GameControl {
    //variables in the FXML
    ...
    //variables created for running the game

    //currentTiles is an array of Buttons and it stores the board
    private Button[][] currentTiles = new Button[Game.board.length][Game.board[0].length];
    //playerButtons array of Buttons of players on who you can press and use Backtrack action
    private Button[] playerButtons = new Button[Game.numOfPlayers];
    //the curAcion tells from which index to show the action tile from the player hand
    private int curAcion = 0;
    public static int xtile = -1;//not needed?
    public static int ytile = -1;//not needed?
    //tell which index has been selected form the player action hand
    private int selectedActionTile = -1;
    //the index of which player has been chosen
    private int chosenPlayer = -1;
    //the images of the actions
    private Image iceIm;
    private Image fireIm;
    private Image weedImg;
    private Image arrow;
    private Tile curentTile;
    //if the tile has been inserted True, if not false, this enforces that you inserted the tile
    //before finishing a move
    private boolean insertOnce;
    //if action has been used then you cant use it again
    private boolean usedAction;
    //if you made a move it is true and this enforces that you move before finishing a move
    ...
    /**
     * this is run before the game is shown
    ...
    public void initialize() throws FileNotFoundException {
        ...
        String fire = "src\\sample\\IMG\\fire.png";
    ...
    /**
     * this refreshes the board each time a change is made
     */
    @FXML
